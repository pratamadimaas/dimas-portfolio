...
const projects = [
  ...
  },
  {
    ...
    summary: "A responsive e-commerce application designed to help UMKM (Usaha Mikro, Kecil, dan Menengah) showcase and sell their products online, complete with an intuitive admin dashboard and seamless checkout process.",
